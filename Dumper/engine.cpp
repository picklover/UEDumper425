...
struct {
  ...
  std::function<bool(void*, void*)> callback;
    ...
    //{"\x48\x8D\x0D\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x48\x8D\x8D\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x48\x8D\x8D\x00\x00\x00\x00\xE8", 32},
    {"\x48\x8B\x0D\x00\x00\x00\x00\x4C\x63\xC0\x49\xC1\xE0\x05\x4C\x03\x04\xD1\xEB\x03\x4C\x8B\xC6\x41\x8b\x40\x10\xC1\xE8\x1D\xA8\x01\x00\x00\x00\x00\x00\x00\x48\x8B\x54",41},
    nullptr
    },
  ...
  {//ShooterGame.exe
   &Default,
    {"\x4C\x8D\x05\x00\x00\x00\x00\xEB\x16\x48\x8D\x0D\x00\x00\x00\x00\xE8\x00\x00\x00\x00", 22}, //GName
    {"\x48\x8D\x1D\x00\x00\x00\x00\x39\x45\xF0\x7C\x20\x48\x8D\x45\xF0", 17}, //Gobject 
    nullptr
  },
  {//SYNCED.exe
   &Default,
    {"\x48\x8D\x00\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x4C\x8B\x00\xC6\x00\x00\x00\x00\x00\x00\x48\x8B\x00\x00\x00\x48\x8B\x00\x48\xC1\x00\x00\x8D\x00\x00\x49\x03\x00\x00\x00\xE8\x00\x00\x00\x00\x83\x00\x00\x00\x74\x00\x8B\x00\x00\x48\x89", 58}, //GName
    {"\x48\x8D\x00\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x89\x00\x00\x48\x83\x00\x00\x5B\xC3\xC7\x00\x00\x00\x00\x00\xC7\x00\x00\x00\x00\x00\x00\x48\x83\x00\x00\x5B\xC3", 40}, //Gobject 
    nullptr
  }
};
...
std::unordered_map<std::string, decltype(&engines[0])> games = {
  ...
  {"SquadGame", &engines[14]},
  {"ShooterGame",&engines[15]},
  {"SYNCED",&engines[16]},
};
...
STATUS EngineInit(std::string game, void* image) {
  ...
  ObjObjects = *(decltype(ObjObjects)*)((DWORD64)objects + 0x10);
